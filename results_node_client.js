...
var ResultsNodeClient = module.exports = function(options) {
  EventEmitter.call(this);
  var self = this;
  this._etcDirectory = '/results';
  options = options || {};
...
util.inherits(ResultsNodeClient, EventEmitter);

ResultsNodeClient.prototype.findAll = function(cb) {
